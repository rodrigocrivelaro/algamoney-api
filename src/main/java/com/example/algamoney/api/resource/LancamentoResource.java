...
//	Implementando pesquisa de lançamento com Metamodel
	...
	public ResponseEntity<Lancamento> buscarPeloCodigo(@PathVariable Long codigo, HttpServletResponse response) {
		if (lancamentoRepository.findOne(codigo) != null) {
			return ResponseEntity.ok().body(lancamentoRepository.findOne(codigo));
		} else {
	...
	public ResponseEntity<Object> handlePessoaInexistenteOuInativaException(PessoaInexistenteOuInativaException ex) {
		String mensagemUsuario = messageSourse.getMessage("pessoa.inexistente-ou-inativa", null, LocaleContextHolder.getLocale()); 
