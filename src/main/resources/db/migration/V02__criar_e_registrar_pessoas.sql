...
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo) values  ('José da Silva', 'Rua dos Joses', '354', 'casa fundo', 'Santa Moca','14.401-151', 'Franca', 'SP', true);
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo) values  ('Maria Nordestina Brazilera', 'Rua dos Nordestinos', '3654', 'casa fundo', 'Santa Maria','14.402-151', 'Franca', 'SP', true);
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo) values ('Carlos Augusto Santada', 'Rua dos Carlos', '3754', 'casa fundo', 'Santa Moca','14.406-151', 'Franca', 'SP', true);
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo) values ('Amora Pereira Ferro do Campo', 'Rua dos Ferros', '3854', 'casa fundo', 'Santa Fé','14.402-153', 'Franca', 'SP', true);
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo) values ('Felisbino de Lima', 'Rua dos Felisbinos', '3954', 'casa fundo', 'Santa Luzia','14.405-159', 'Franca', 'SP', true);
